...
# %% ../notebooks/05_cassini_uvis.ipynb 7
import tomlkit
...
# %% ../notebooks/05_cassini_uvis.ipynb 8
storage_root = config.storage_root / "missions/cassini/uvis"
storage_root

# %% ../notebooks/05_cassini_uvis.ipynb 9
class DataManager:
    def __init__(
        self, 
...
# %% ../notebooks/05_cassini_uvis.ipynb 23
...
# %% ../notebooks/05_cassini_uvis.ipynb 26
def get_user_guide():
    url = URL(
