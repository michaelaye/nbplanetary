# AUTOGENERATED! DO NOT EDIT! File to edit: ../../notebooks/api/02d_pds.opusapi.ipynb.

# %% auto 0
__all__ = ['base_url', 'metadata_url', 'image_url', 'dic', 'OPUSImageURL', 'OPUSObsID', 'OPUS']

# %% ../../notebooks/api/02d_pds.opusapi.ipynb 2
