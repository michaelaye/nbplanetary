# AUTOGENERATED! DO NOT EDIT! File to edit: 03_isis.specialpixels.ipynb (unless otherwise specified).

__all__ = ['__all__', 'SPECIAL_PIXELS']
...
def _make_num(num, dtype):
    return numpy.frombuffer(num, dtype=dtype)[0]
